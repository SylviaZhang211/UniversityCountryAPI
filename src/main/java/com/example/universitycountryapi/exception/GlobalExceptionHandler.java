...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NoUniversityFoundException.class)
    public ResponseEntity<Object> handleNoUniversityFoundException(NoUniversityFoundException ex, WebRequest request) {
